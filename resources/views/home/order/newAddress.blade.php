...
<form  id="checkoutForm" action="{{url('order/address')}}" method="post">
...
<dl class="item" >
<dt>
<strong class="itemConsignee">收件人姓名：</strong>
</dt>
<dd>
<p class="tel itemTel">收件人电话：</p>
<p class="itemRegion">收件人地址：</p>
<p class="itemStreet">下单时间：</p>
...
<div class="item use-new-addr"  id="J_useNewAddr" data-state="off">
     <span class="iconfont icon-add"><a href="{{url('order/newAddress')}}"><img src="{{URL::asset('home/images/add_cart.png')}}" /></a></span>
...
<div class="ft clearfix" >
    ...
    <button type="button" class="btn btn-primary  btn-small " id="J_editAddrOk" onclick="address()">保存</button>
</div>
</div>
</form>
<!--点击弹出新增/收货地址界面end-->
...
<div class="col col-1">
<div class="g-pic">
<img src="{{URL::asset('home/images/shangpinxiangqing/X1.png')}}" width="40" height="40" />
</div>
<div class="g-info">
...
<div class="col col-1">
<div class="g-pic">
<img src="{{URL::asset('home/images/shangpinxiangqing/X-1.png')}}" width="40" height="40" />
</div>
<div class="g-info">
<a href="#" target="_blank">
赛亿（shinee)取暖器家用/取暖电器/电暖器/电暖气台式摇头暖风机HN2118PT
...
<div class="col col-1">
<div class="g-pic">
<img src="{{URL::asset('home/images/shangpinxiangqing/X2.png')}}" width="40" height="40" />
</div>
<div class="g-info">
<a href="#" target="_blank">
赛亿（shinee)取暖器家用/取暖电器/电暖器/电暖气台式摇头暖风机HN2118PT
...
<div class="fl lss-img"><img src="{{URL::asset ('home/img/icon/code.png')}}" alt=""></div>
