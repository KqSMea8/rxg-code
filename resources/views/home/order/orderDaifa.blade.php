...
<li class="cur"><a href="{{url('order/daifa')}}?id=3">待发货</a></li>
...
<div class="ci5">
   ...
   @if($v->orderStatus==3) 待发货


   @endif
</p> 
<p><a href="{{url("order/logistics")}}"><font color="blue">物流跟踪</font></a></p> <p><a href="{{url('order/orderContent')}}?id={{$v->orderId}}">订单详情</a></p></div>
<div class="ci5 ci8"><p>剩余15时20分</p> <p><a class="member-touch">等待发货</a> </p> <p><a href="{{url('order/resetOrder')}}?id={{$v->orderId}}">取消订单</a> </p></div>
</div>
</li>
@endforeach
