            ...
            <table>
                <tr>
                    ...
                    <td class="col-lg-6 input-group-sm">
                        <input type="text" class="form-control" placeholder="优惠券名称" name="name"/>
                    </td>
                </tr>
                <tr>
                    <td class="col-lg-2 text-right">优惠金额：</td>
                    <td class="col-lg-6 input-group-sm">
                        <input type="text" class="form-control" placeholder="优惠金额" name="ticket_money"/>
                    </td>
                </tr>
                <tr>
                    <td class="col-lg-2 text-right">有效时间：</td>
                    <td class="col-lg-6 input-group-sm">
                          <input class="btn btn-default" type="text" onClick="WdatePicker()" placeholder="开始日期" name="start_Time"> ~~
                    <input class="btn btn-default" type="text" onClick="WdatePicker()" placeholder="结束日期" name="end_Time">
                    </td>
                </tr>
                <tr>
    ...
    <script>
        $('button[id="submit"]').on('click',function (e) {
            ...
            $.ajax({
                ...
                url: "{{url('admin/ticket/ticketAdddo')}}" ,//url
                data: formData,
                success: function (res) {
                    if(parseInt(res.code)===2){
                        ...
                        layer.msg(res.message,{
                            ...
                            location.href="{{url('admin/ticket/ticketAdd')}}";
                        });
                    }
                }
            })
