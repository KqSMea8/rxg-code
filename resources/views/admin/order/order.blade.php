    ...
    <div class="container" style="width:100%">
        ...
        <span>
            <table width="100%">
                <tr class="row">
                    <td class="col-md-12">
                <form action="{{URL::asset('admin/order/orderList')}}" method="get" style="width: 100%" class="form-inline" id="form">
        ...
        <table class="table-hover table table-bordered">
            ...
            @foreach($orderdata as $k=>$v)
                <tr>
                    ...
                    <td>{{$v->addTime}}</td>
                    <td><a href="{{url('admin/order/adminContent')}}?id={{$v->orderId}}" class="btn btn-primary btn-xs">查看详情</a></td>
                </tr>
            @endforeach
            </tbody>
        </table>
