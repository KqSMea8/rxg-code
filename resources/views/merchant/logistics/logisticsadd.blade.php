            ...
            <table>
                <tr>
                    ...
                    <td class="col-lg-6 input-group-sm">
                        <input type="text" class="form-control" placeholder="物流仓库公司名称" name="name"/>
                    </td>
                </tr>
                <tr>
                    <td class="col-lg-2 text-right">联系方式：</td>
                    <td class="col-lg-6 input-group-sm">
                        <input type="text" class="form-control" placeholder="联系方式以座机号为主" name="tel"/>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="col-lg-6 input-group-sm text-center">
                        ...
                        <button id="submit" type="submit" class="btn" style="background-color: #4fd98b;width: 150px">
                            <i class="glyphicon glyphicon-plus"></i> 添加新物流
                        </button>
                    </td>
                </tr>
            </table>
    ...
    <script>
        $('button[id="submit"]').on('click',function (e) {
            ...
            $.ajax({
                ...
                url: "{{url('merchant/logistics/logisticsAdddo')}}" ,//url
                data: formData,
                success: function (res) {
                    if(parseInt(res.code)===2){
                        ...
                        layer.msg(res.message,{
                            ...
                            location.href="{{url('merchant/logistics/logisticsAdd')}}";
                        });
                    }
                }
            })
