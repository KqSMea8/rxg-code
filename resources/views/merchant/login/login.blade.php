...
<div id="login-page">
    <div class="container">
        <form id="form" class="form-login" action="{{url('merchant/login/login_do')}}" method="post">
            {{csrf_field()}}
            <h2 class="form-login-heading">欢迎登录任性购商家后台</h2>
            <div class="login-wrap">
                <input type="text" name="shopName" class="form-control" placeholder="请输入店铺名称" autofocus>
                <br>
...
<script>
    ...
    $('button[type="submit"]').on('click',function (e) {
        ...
        $.ajax({
            ...
            url: "{{url('merchant/login/loginDo')}}" ,//url
            ...
            success: function (res) {
                if(parseInt(res.code)===2){
                    ...
                    location.href="{{url('merchant/index')}}";
                }
            }
        })
    })
