...
@section('content')
    ...
    <div class="container" style="margin-top: 2%;">
        <div class="page-title" style="margin-bottom: 1%">
            <span style="font-size: 16px;"><em>店铺信息修改</em></span>
        ...
        <form id="form" method="post" enctype="multipart/form-data">
            <table>
                ...
                <tr>
                    ...
                    <td class="col-lg-6 input-group-sm"><input type="text" name="shopName" value="{{$data->shopName}}" class="form-control"/></td>
                </tr>

                <tr>
                    <td class="col-lg-2 text-right">店铺图标</td>
                    <td class="col-lg-6 input-group-sm"><input type="file" name="shopImg"class="form-control"/></td>
                </tr>
                <tr>
                    <td class="col-lg-2 text-right"></td>
                    <td class="col-lg-4 input-group-sm text-center">
                        <input type="submit" value="添加" class="btn" style="background-color: #4fd98b;width: 50%"/></td>
                </tr>
            </table>
        </form>
    </div>
